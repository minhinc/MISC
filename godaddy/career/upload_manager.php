...
if(isset($_FILES["photo"]["error"])){
    if($_FILES["photo"]["error"] > 0){
        ...
        $allowed = array("pdf" => "application/pdf",  "docx" => "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "txt" => "text/plain");
...
//        $maxsize = 5 * 1024 * 1024;
        $maxsize = 100 * 1024;
        if($filesize > $maxsize) die("<p style=\"color:#ff0000\">Error: File size is larger than 100KB the allowed limit.</p>");
