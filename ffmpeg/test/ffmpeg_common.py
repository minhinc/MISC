...
python3 ffmpeg_common.py --profile <minh|tech|miss|math> [--offset <number>] "<title>" "(=<referencevideo.mp4>,(<timestamp1,timestamp2>)" "(<nonreferencevideo.mp4>,audio.mp3,0.8)>,(<timestamp1,timestamp2>))" "((panzoomimage.png,panzoomimage2.png),audio.mp3),(<filtername>,<duration>)" .... "<[gif|.mp4|.mov|.png|text]:<audio>:<volume> <filter:position>,(<timestamp1,timestamp2>)" ....
