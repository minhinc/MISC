...
tempduration=None
stroketuple.append(('techlogotext_t.png','W-w,h','2-'+str(g.libi.duration-2)))
stroketuple.append((g.utili.logotext(size=0.3,textdata=('Tech ','Awal','A Tech Research Firm'),textcolor=((255,85,0,255),(0,0,255,255),(200,200,200,255))),5,0))
#omni
