...
class earth(shader):
 def __init__(self,*arg,**kwarg):
  super().__init__(**dict({'objfile':'sphere.obj','material_diffuse':{'__UNKNOWN__':'earth.png'},'fixtransformation':[[4,0,0],['s',0.6,0.6,0.6]],'extratransformation':[[23,0,0,1]],'material_ambient':(0.3,0.3,0.3)},**kwarg))
