...
class moon(shader):
 def __init__(self,*arg,**kwarg):
  super().__init__(**dict({'objfile':'sphere.obj','material_diffuse':{'__UNKNOWN__':'MoonMap2_2500x1250.jpg'},'fixtransformation':[[4,0,0],['s',0.64,0.64,0.64]]},**kwarg))
  self.children.append(earth(transformation=[[90,0,1,0]]))
