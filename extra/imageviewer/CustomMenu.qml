...
Menu {
 ...
 onCurrentIndexChanged : {
  for (var i=0;i<count;i++) {
   if (typeof itemAt(i).customsubmenu !== "undefined" && i!=currentIndex && itemAt(i).customsubmenu.opened) {
   ...
   } else if (typeof itemAt(i).customsubmenu !== "undefined" && i==currentIndex && !itemAt(i).customsubmenu.opened) {
