...
def download(searchstring,pagecount=0):
...
def downloadlink(linkp):
 return repr(urllib2.urlopen(urllib2.Request(linkp,headers={'User-Agent': 'Mozilla/44.0.2'}),timeout=90).read().decode('utf-8'))
